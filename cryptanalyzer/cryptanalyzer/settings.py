"""
Django settings for cryptanalyzer project.
...
SECRET_KEY = 'cryptl@lnt%vlj9*9f#+cu+di(b$%%z^++d#gwyw54s_7nl8o__o4a%'
...
ROOT_URLCONF = 'cryptanalyzer.urls'
...
WSGI_APPLICATION = 'cryptanalyzer.wsgi.application'
